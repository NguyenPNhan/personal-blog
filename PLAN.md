...
- Homepage social accounts are configured in `src/data/socialAccounts.ts`; links and usernames are optional. Icon files belong in `src/assets/icons` and are imported directly from the account data.
